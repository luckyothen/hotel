...
const aboutUsData = ["About Us", "Contact Us", "History", "Gallery", "Location"];
      ...
      <Container>
        <FooterWrapperStyled>
          <FooterLinkGroupStyled>
            <Branding color="#1DC1F8" marginBottom="1rem">Zogo Hotel</Branding>
          ...
          <FooterLinkGroupStyled>
            <FooterLinks title="Latest News" links={latestNewsDataComponents} hover="hover" />
          </FooterLinkGroupStyled>
          <FooterLinkGroupStyled>
            <FooterLinks title="Useful Links" links={aboutUsComponents} hover="hover" />
          </FooterLinkGroupStyled>
          <FooterLinkGroupStyled>
